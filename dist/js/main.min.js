...
const registrationCloseDate1 = new Date('September 23, 2024 23:59:59').getTime();
// const registrationCloseDate1 = new Date().getTime()
const registrationCloseDate2 = new Date('September 28, 2024 23:59:59').getTime();
// const registrationCloseDate2 = new Date().getTime()
const eventStart = new Date('October 2, 2024 22:00:00').getTime();
...
const updateCountdown = setInterval(function() {
    ...
    if (now < registrationOpenDate) {
    ...
    } else if (now >= registrationOpenDate && now <= registrationCloseDate1) {
        // During the registration period
        const distance = registrationCloseDate1 - now; // Calculate the distance between now and the target date
        ...
        document.getElementById("registerButton").setAttribute('href', 'https://devfolio.co');
    } 
    else if (now >= registrationCloseDate1 && now <= registrationCloseDate2) {
        // During the registration period
        const distance = registrationCloseDate2 - now; // Calculate the distance between now and the target date
